...
public class MetastoreWriterDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = MetastoreWriterDialog.class; // for i18n purposes, needed by Translator2!!

  private Text wStepname;

  private Combo wNamespaceField;
  private Combo wElementTypeField;
  private Combo wElementNameField;
  private Combo wAttributePathField;
  private Combo wAttributeIndexField;
  private Combo wAttributeValueField;
  
  private MetastoreWriterMeta input;

  public MetastoreWriterDialog( Shell parent, Object inputMetadata, TransMeta transMeta, String stepname ) {
    super( parent, (BaseStepMeta) inputMetadata, transMeta, stepname );
    input = (MetastoreWriterMeta) inputMetadata;
  }
  ...
  @Override public String open() {
    ...
    wNamespaceField = new Combo( shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wElementTypeField = new Combo( shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wElementNameField = new Combo( shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wAttributePathField = new Combo( shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wAttributeIndexField = new Combo( shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wAttributeValueField = new Combo( shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
  ...
  private void getInfo(MetastoreWriterMeta meta) {
